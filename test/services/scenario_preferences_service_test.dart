...
void main() {
  ...
  test('loadPollingPreferences uses parsed values when valid', () async {
    final PollingPreferences prefs =
      ...
      inGeofenceDistanceMetersKey: 'in_geofence',
      ...
      defaultInGeofenceDistanceMeters: 200,
      ...
      inGeofenceDistanceMeterOptions: const <int>[100, 200, 300],
  ...
  test('loadPollingPreferences falls back to defaults for invalid options',
    ...
    final PollingPreferences prefs =
      ...
      inGeofenceDistanceMetersKey: 'invalid_in_geofence',
